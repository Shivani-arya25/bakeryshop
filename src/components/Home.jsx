...
import img from "../assets/img/pink-birthday-cake-hd.jpg";
import Button from "../layouts/Button";

const Home = () => {
  return (
    <div className=" min-h-screen flex flex-col justify-center lg:flex-row lg:justify-between items-center lg:px-32 px-5 gap-10 bg-gradient-to-r from-[#66e1d4] to-[#ab2e6f] ">
      <div className=" w-full lg:w-2/4 space-y-4 mt-14 lg:mt-0">
        <h1 className="font-semibold text-5xl text-center lg:text-start leading-tight">
        “Let’s rise to the occasion and bake!”
        </h1>
        <p>
        "You can't buy happiness, but you can buy freshly baked goodies, 
      ...
      <div className="relative">
        ...
        <div className=" absolute bg-white px-8 py-2 bottom-0 -left-10 rounded-full">
          <h2 className=" font-semibold">Cake</h2>
        </div>
      </div>
    </div>
  );
